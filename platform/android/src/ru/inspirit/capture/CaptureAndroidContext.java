...
public class CaptureAndroidContext extends FREContext 
{
	...
	public Map<String, FREFunction> getFunctions() {
		...
		map.put(ExposureAtPointFunction.KEY, new ExposureAtPointFunction());
		map.put(GetFlashModeFunction.KEY, new GetFlashModeFunction());
		map.put(SetFlashModeFunction.KEY, new SetFlashModeFunction());
		map.put(CaptureAndSaveImageFunction.KEY, new CaptureAndSaveImageFunction());
