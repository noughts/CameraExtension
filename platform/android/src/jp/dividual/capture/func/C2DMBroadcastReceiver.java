...
import jp.dividual.capture.C2DMExtension;
...
public class C2DMBroadcastReceiver extends BroadcastReceiver {
	...
	{
		notificationIcon = Resources.getResourseIdByName(context.getPackageName(), "drawable", "icon_small");
		...
		customLayoutImage = Resources.getResourseIdByName(context.getPackageName(), "drawable", "icon");
	}
	...
	public void handleMessage(Context context, Intent intent) {
		try {
			...
			*/
			...
			if (ctxt != null)
			{
				ctxt.dispatchStatusEventAsync("COMING_FROM_NOTIFICATION", "coming from notification");
			}
