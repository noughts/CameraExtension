...
public class IsExposureSupported implements FREFunction {

    public static final String KEY = "isExposureCompensationSupported";

    private static final String TAG = "IsExposureSupported";
